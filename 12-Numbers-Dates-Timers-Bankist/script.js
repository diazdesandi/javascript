...
// Base 10 - 0 to 9. 1/10 = 0.1. 3/10 = 0.3333333333333333
// Binary base 2 - 0 1
console.log(0.1 + 0.2);

console.log(Number('23'));
console.log(+'23'); // + sign converts to number

// Parsing
console.log(Number.parseInt('30px', 10)); // 10 is base, default is 10
...
console.log(Number.isNaN(20)); // checks if number
console.log(Number.isNaN('20'));
console.log(Number.isNaN(+'20X'));
console.log(Number.isNaN(23 / 0));

// Checking if a value is a number
console.log(Number.isFinite(20)); // checks if finite, better option than isNaN.
console.log(Number.isFinite('20'));
console.log(Number.isFinite(+'20X'));
console.log(Number.isFinite(23 / 0));

console.log(Number.isInteger(23)); // checks if integer
...
// Always gives us a number between min and max
...
console.log(new Date('Aug 2 2020 18:40:03'));
...
console.log(future.getDay()); // 0-6, day of the week
